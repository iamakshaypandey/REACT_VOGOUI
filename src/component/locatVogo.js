    ...
    return (
      ...
      <section className='container-fluid  mt position-relative'>
          <div className='background d-flex'>
              ...
              <div className=''>
                <h6 className='text-warning mt-4 text-left'>DOWNLOAD APP</h6>
                ...
                <div className='d-flex'>
                  <img style={{width:'30%',height:'30%',}} className='m-2' src={appstroe} alt="googleimg" />
                  <img style={{width:'30%',height:'30%',}} className='m-2' src={googleimg} alt="appstore" />
                </div>
              </div>
